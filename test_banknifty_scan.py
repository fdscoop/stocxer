#!/usr/bin/env python3
"""
Test BANKNIFTY Scan as User from Dashboard
...
def main():
    ...
    # =========================================================================
    print("\n" + "=" * 80)
    print("🎯 STEP 3: ACTIONABLE SIGNAL (/signals/BANKNIFTY/actionable)")
    print("=" * 80)
    
    signal_url = "http://localhost:8000/signals/BANKNIFTY/actionable"
