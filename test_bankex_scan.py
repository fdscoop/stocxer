#!/usr/bin/env python3
"""
BANKEX Scan Simulation - Same as user clicking scan on dashboard
"""
import sys
...
print('=' * 70)
print('🧑‍💻 USER SIMULATION: Scanning BANKEX from Dashboard')
print('=' * 70)
...
print()
print('━' * 70)
print('🔍 Fetching BANKEX spot price...')
quote = fyers_client.get_quotes(['BSE:BANKEX-INDEX'])
if quote and 'v' in quote and quote['v']:
    spot = quote['v'][0].get('lp', 0)
    print(f'   ✅ BANKEX Spot: ₹{spot:,.2f}')
else:
...
mtf_result = mtf.analyze('BSE:BANKEX-INDEX', [
    Timeframe.DAILY,
    Timeframe.FOUR_HOUR,
    Timeframe.ONE_HOUR,
...
print()
print('╔' + '═' * 68 + '╗')
print('║' + '🎯 BANKEX SIGNAL'.center(68) + '║')
print('╠' + '═' * 68 + '╣')
print(f'║  Index: BANKEX'.ljust(69) + '║')
