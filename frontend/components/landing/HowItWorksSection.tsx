...
const steps = [
    {
        ...
        icon: Search,
        title: 'Scan',
        subtitle: 'Select Index & Expiry',
        description: 'Pick an index (NIFTY, BANKNIFTY, FINNIFTY, MIDCPNIFTY, SENSEX, BANKEX), choose weekly or monthly expiry, and hit scan.',
    ...
    },
    {
        ...
        icon: Cpu,
        title: 'Analyze',
        subtitle: 'Watchman AI v4.0 Processing',
        description: 'Watchman AI v4.0 runs ICT Top-Down across 6 timeframes, AMD phase detection, ML models, P&L simulation, Greeks analysis, and sentiment scoring.',
    ...
    },
    {
        ...
        title: 'Decide',
        subtitle: 'Complete Signal with Grade',
        description: 'Get a specific option strike, entry/targets/SL, trade grade (A–F), P&L scenarios, theta projections, scalp feasibility, and a confidence breakdown.',
