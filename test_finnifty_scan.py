#!/usr/bin/env python3
"""
FINNIFTY Scan Simulation - Same as user clicking scan on dashboard
"""
import sys
...
print('=' * 70)
print('🧑‍💻 USER SIMULATION: Scanning FINNIFTY from Dashboard')
print('=' * 70)
...
print()
print('━' * 70)
print('🔍 Fetching FINNIFTY spot price...')
quote = fyers_client.get_quotes(['NSE:NIFTY_FIN_SERVICE-INDEX'])
if quote and 'v' in quote and quote['v']:
    spot = quote['v'][0].get('lp', 0)
    print(f'   ✅ FINNIFTY Spot: ₹{spot:,.2f}')
else:
...
mtf_result = mtf.analyze('NSE:FINNIFTY-INDEX', [
    Timeframe.DAILY,
    Timeframe.FOUR_HOUR,
    Timeframe.ONE_HOUR,
...
strike = chain.atm_strike - 100 if rec_type == 'PUT' else chain.atm_strike + 100
...
print()
print('╔' + '═' * 68 + '╗')
print('║' + '🎯 FINNIFTY SIGNAL'.center(68) + '║')
print('╠' + '═' * 68 + '╣')
print(f'║  Index: FINNIFTY'.ljust(69) + '║')
