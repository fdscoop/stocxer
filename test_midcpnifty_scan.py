#!/usr/bin/env python3
"""
MIDCPNIFTY Scan Simulation - Same as user clicking scan on dashboard
"""
import sys
...
print('=' * 70)
print('🧑‍💻 USER SIMULATION: Scanning MIDCPNIFTY from Dashboard')
print('=' * 70)
...
print()
print('━' * 70)
print('🔍 Fetching MIDCPNIFTY spot price...')
quote = fyers_client.get_quotes(['NSE:MIDCPNIFTY-INDEX'])
if quote and 'd' in quote and quote['d'] and quote['d'][0].get('v', {}).get('lp'):
    spot = quote['d'][0]['v'].get('lp', 0)
    print(f'   ✅ MIDCPNIFTY Spot: ₹{spot:,.2f}')
else:
...
mtf_result = mtf.analyze('NSE:MIDCPNIFTY-INDEX', [
    Timeframe.DAILY,
    Timeframe.FOUR_HOUR,
    Timeframe.ONE_HOUR,
...
strike = chain.atm_strike - 50 if rec_type == 'PUT' else chain.atm_strike + 50
...
print()
print('╔' + '═' * 68 + '╗')
print('║' + '🎯 MIDCPNIFTY SIGNAL'.center(68) + '║')
print('╠' + '═' * 68 + '╣')
print(f'║  Index: MIDCPNIFTY'.ljust(69) + '║')
...
print()
print('=' * 70)
print('✅ MIDCPNIFTY SCAN COMPLETE!')
print('=' * 70)
